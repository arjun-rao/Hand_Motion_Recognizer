...
public class AccelerometerSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText server_edit = (EditText) this.findViewById(R.id.server_edit);
        Settings settings = Settings.getInstance();
        server_edit.setText(settings.getServer_url());
        server_edit.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                Settings settings = Settings.getInstance();
                settings.setServer_url(s.toString());
            }
        });
    ...
    public void onServerEditChanged(View view) {
