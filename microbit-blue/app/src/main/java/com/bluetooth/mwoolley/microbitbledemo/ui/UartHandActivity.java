...
public class UartHandActivity extends AppCompatActivity implements ConnectionStatusListener {
    ...
    ArrayList<String> _listEntries = new ArrayList<String>();    // String-ArrayList for storing the itmes that should be shown in the list
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uart_hand);
        ...
        // Create ListView
        ListView listView = (ListView) this.findViewById(R.id.messages);

        // Set Array-Adapter
        _arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, _listEntries);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_uart_avm_help) {
            Intent intent = new Intent(UartHandActivity.this, HelpActivity.class);
    ...
    private void showMsg(final String msg) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ((TextView) UartHandActivity.this.findViewById(R.id.message)).setText(Html.fromHtml(msg));
            }
        });
    }
    ...
    private void addMessage(final String msg) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                UartHandActivity.this._listEntries.add(msg);

                UartHandActivity.this._arrayAdapter.notifyDataSetChanged();
                ((TextView) UartHandActivity.this.findViewById(R.id.avm_guess_count)).setText("Messages: "+Integer.toString(gc));
            }
        });
    }
    ...
    private void showGuessCount() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ((TextView) UartHandActivity.this.findViewById(R.id.receive_msg_count)).setText("Guesses: "+Integer.toString(gc));
            }
        });
    }
